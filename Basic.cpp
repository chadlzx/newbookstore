...
婵犵妲呴崑鎾跺緤妤ｅ啯鍋嬮柡鍥ュ灩閸屻劍绻涢幋娆忕仾闁哄拋鍓熼幃姗€鎮欑捄渚闂佸啿鍢查悧蹇曟閹烘挸绶炲┑鐘插珔閿濆鍤夐柍鍝勫暊閸嬫挸鈻撻崹顔界亪缂備胶绮崝娆撳Υ閸涢偊妲奸梺鐟板槻閹虫ê顕ｉ幘顔藉€婚柛鈩冾焺閻斿吋鈷戦柤濮愬€曟禒婊勪繆椤愩埄鍤熸�?
...
缂傚倸鍊烽悞锕傘€冭箛娑樼婵炴垶姘ㄩ崡姘舵煛婢跺鐏嶉柡瀣叄閺屽秹濡烽妸锔惧涧闂佺瀛╅悷鈺呭蓟濞戙垹绫嶉柟瀵稿Т鐢劎绱撴担浠嬪摵缂佽鐗嗛悾宄邦潩椤戣姤顫嶅┑鈽嗗灥閸嬫劖�?user 闂傚倷绀侀幖顐﹀磹缁嬫５娲晲閸涱亝鐎婚梺闈涚箞閸婃牠寮查鍕€堕柣鎰煐椤ュ鏌ｈ箛銉х？闁逞屽墰閸嬶綁宕愬☉姗嗘禆闁靛ň鏅涚粈澶愭煟閺傚灝鎮戦柛搴″閵囧嫰寮埀顒勵敄濞嗘挸瑙﹂柛宀€鍋為悡鏇熶繆閵堝嫮鍔嶇紒鈧崘鈺€绻嗘い鎰枑濞呭牏绱掗悩宕団槈閾绘牠鏌涢幇顓炲姢闁诡喕绶氬娲嚒閵堝懍绮跺┑鈽嗗亝閻╊垶骞冨ú顏勭闁挎洍鍋撴俊顐ｏ耿閺屾盯濡烽鐐搭€嶅銈嗗姃缁瑩寮婚妸銉㈡婵☆垰鐏濋顓㈡⒑閹肩偛濡奸柣蹇斿哺楠炲牓濡歌閸嬫捇鏁愭惔鈥茬凹闂佽棄鍊搁澶愬蓟閳╁啯濯撮柣鐔煎亰閳ь剚绮庣槐鎺撴媴閸濄儲鎲肩�?
	user 闂傚倷绀侀幖顐﹀磹閻熼偊鐔嗘慨妞诲亾鐎规洖缍婂畷锟犳倻閸℃鐣肩紓鍌欐祰濞咃綁骞愮缓�?闂傚倷鐒﹀鍨焽閸ф绀夌€广儱顦弰銉︾箾閹存瑥鐏╅柣顓燁殜閹鏁愭惔婵堟殫闂佺顑冮崝鎴﹀蓟閵娿儮妲堟慨妤€妫欒倴闂?
...
exit #0 闂傚倸鍊风欢锟犲磻閳ь剟鏌涚€ｎ偅宕岄�?
su [user] [passwd] #0 闂傚倷娴囬惃顐﹀幢閳轰焦顔勭�?
logout #1  闂傚倷绀侀幉锟犳偡閿旂偓绠掗梺鑽ゅУ閸旀宕伴弽褜鍤曢柣銏犲閺佸倿鏌涢埄鍐夸緵濞寸媭鍣ｉ�?
useradd [user闂傚倷鑳堕崑銊╁磿閸欏顩茬紒顖滅墘 [passwd] [7/3/1] [name] #3闂傚倷鐒︾€笛呯矙閹烘鍤屽Δ锝呭幗閻戣棄绀冩い鏃囧亹椤︻噣姊虹紒姗嗙劸濞存粠鍓熼、鏃堝础閻愨晜顫嶉梺鐟扮仢閸熲晝鑺辨總鍛婂€甸柛顭戝亝閻ㄦ垿鏌嶈閸撴繈锝炴径灞芥瀳鐎广儱鎷嬮悞浠嬫煕椤愮姴鍔滈柍閿嬫閺岀喖鏌囬敃鈧弸鐔兼煟閿濆鎲鹃柡宀嬬秮閿濈偤顢楅埀顒佷繆娴犲鐓曢柍鍝勫€诲ú鎾煛娴ｅ摜肖濞寸媴绠撻幊鏍煛閸愨晛鏋撻梻鍌欒兌閸樠囨偪閸ヮ灛娑㈠礋椤栨艾鐎梺鍛婎殘閸庢劙宕甸崼銉ョ骇闁绘劖娼欓ˉ瀣煟閻斿摜绠為柟顔筋焾缁犳盯骞橀崜渚囧悈缂傚倷绶￠悡鍫ュ礈閻旂厧绠犳繛鎴欏焺閺佸倿鏌涢弴銊ュ箻闁伙絾濞婂娲传閸曞灚笑闂佸摜鍠愬娆撯€栨繝鍋椽顢旈崨顓炲闂備礁鎲″ú锕傚窗閺嶎厔鍥煛閸涱喚�?
register [user闂傚倷鑳堕崑銊╁磿閸欏顩茬紒顖滅墘 [passwd] [name] #0闂傚倷鐒︾€笛呯矙閹烘柨鏋堢€广儱顦弸渚€鏌ｉ幇顒佹儓缂佲偓閸愵喗鍊堕柣鎰硾娴滆銇勮箛鎾宠埞闁宠棄顦甸獮娆撳礃瑜忛惄搴ㄦ⒑濮瑰洤鐒洪柛瀣工椤曪綁宕归銏㈢獮闁硅壈鎻徊鍧楊敊閹邦厾绠鹃悗娑欘焽閻绱掔€ｎ偄濮堢紒宀冮哺缁绘繈宕惰閻ｅ啿顪冮妶鍡欏缂侇喖绉归幃楣冩焼瀹ュ棛鍘告繝銏ｆ硾閿曘倝寮抽敐鍡曠�?闂傚倷鐒﹀鍨焽閸ф绀夌€广儱顦�?
delete [user闂傚倷鑳堕崑銊╁磿閸欏顩茬紒顖滅墘 #7闂傚倷鐒︾€笛呯矙閹烘鍤屽Δ锝呭暙閸ㄥ倻鎲搁悧鍫濈瑲闁抽攱妫冮弻鏇㈠醇濠靛浂妫ら梺鍛娚戦悷鈺呭蓟閿濆缍栨い鎺嗗亾濠碘€茬矙閺?
passwd [user闂傚倷鑳堕崑銊╁磿閸欏顩茬紒顖滅墘 [old闂傚倷鑳堕崑銊╁磿閸欏顩烽柣鏇犵）swd(if not root)] [new闂傚倷鑳堕崑銊╁磿閸欏顩烽柣鏇犵）swd] #1闂傚倷鐒︾€笛呯矙閹烘鏁嗛柣鐐甸兏t婵犵數鍋為崹鍫曞箰閸濄儳鐭撻柣鐔诲焽閳ь剚甯″畷婊勬媴閻熺増姣囧┑鐐舵彧缂嶄礁顭囬懡銈囩闁哄稁鍘介悡鏇㈡煙闁箑骞橀柟鍐插娣囧﹪顢曢顫敖闂侀€炲苯澧存繛浣冲吘娑樷槈閵忊€充函濠电姴锕ら悧濠囧疾椤掑嫭鍊堕柣鎰煐椤ュ鈧數澧楅幐鎼佹箒闂佹寧绻傚Λ娑㈠箠閸℃鐔嗛悹鍝勬惈椤忣厽顨ラ悙宸剶闁诡喗绮撻幊鐐哄Ψ閵堝洤绗￠�?

[user-id] 闂傚倷绀侀幉锛勫垝鎼达絿绠旀慨鎺嬪€箂swd] 闂傚倷绀侀幉锟犳偋閺囥垹绠犻幖娣妼缁犳岸鏌涢銈呮瀾濞存嚎鍊濋弻锝夊箛椤旇姤姣勯梺杞扮窔缁犳牠寮婚敓鐘茬妞ゅ繐瀚呴妷鈺傜厓閻熸瑥瀚晶鐢碘偓娈垮枙缁瑩骞婇弽顓炵厸闁稿本绮嶅▓鎼佹⒒娴ｈ姤銆冮柣鎺炵畱椤灝顫滈埀顒勫箖妤︽妲鹃梺閫炲苯澧紒瀣浮閵嗗啴宕卞☉娆忓墾濠电娀娼уú銊╁煝閺冨牊鍊甸柨婵嗙凹缁ㄥ鏌ｈ箛鎿勫姛缂佽鲸甯￠獮鍡氼槻闁活煉绱曠槐鎺撴綇閵娧呯暫缂備礁顑呴ˇ顖烆敇婵傜閱囬柍鎯帮骏閸ㄨ棄�?婵犵數鍋為崹鍫曞箹閳哄倻顩叉繝濠傜墛閸嬨倗鎲歌箛鏇炲�?
[name] 婵犵數鍋為崹鍫曞箹閳哄懎鍌ㄩ柧蹇撴贡缁犳柨顭块懜闈涘閻熸瑱闄勯妵鍕箛閳轰讲鍋撻幇鏉挎瀬闁告洦鍨遍悡娑氣偓骞垮劚濞层垽鍩€椤掆偓椤戝洤危閹邦兘鏀介柛銉㈡杹閺嬫牠鎮楅獮鍨姎闁绘绻愰悺顓㈡�?婵犵數鍋為崹鍫曞箹閳哄倻顩叉繝闈涱儐閸庢垿鏌ｉ敐鍛槵�?0婵犵數鍋為崹鍫曞箹閳哄倻顩叉繝濠傜墛閸嬨倗鎲搁弮鍫濈�?

select [ISBN]
#3闂傚倷鐒︾€笛呯矙閹烘垹鏆嗛柟闂寸閻掑灚銇勯幒鍡椾壕濡炪倧瀵岄崹鍫曞箖閸撗呯妞ゃ垻顑峃婵犵數鍋為崹鍫曞箰妤ｅ啫纾块柕鍫濇礌閸嬫捇宕归锝囨闂侀€炲苯澧叉い顐㈩樀閹虫繃銈ｉ崘銊у姦濡炪倖甯掗崯顐ｇ鐟欏嫮绠鹃柛顐ゅ枎閻忓鈧娲栭悥鐓庣暦閿濆唯闁靛鍎哄顒勬⒒娴ｇ懓顕滅紒瀣灴閹本鎷呯悰鈥充壕婵ǜ鍎遍悘顏嗙磼鐎ｎ亶妲告い鎾炽偢瀹曘劑顢涘☉娆忔灈闂傚倷绶氬鑽ゆ嫻閻旂厧绀夌€光偓閸曨偄鐎銈嗙墱閸嬫稓绮堥崱妯肩闁瑰鍎愰悞鐣岀磼閹插鐣甸柟顔肩秺瀹曞爼鎳滃▓搴撳亾濡ょ垂N闂傚倷鐒﹂惇褰掑礉瀹€鈧埀顒佸嚬娴滎亜鐣峰┑瀣亜闁兼祴鏅涚粊锕傛煟閻樿崵绱版繛鍜冪到閳绘挸煤椤忓懐鍘遍棅顐㈡处濮婂綊寮搁崟顓犵＝鐎广儱妫楅悘锔剧磼瀹€鍕喚闁糕晛瀚板畷妯款槾缂佲偓閳ь剟姊绘担椋庝覆缂佹煡绠栭幃鐤樄闁糕晝鍋ゅ浠嬵敃閵堝鏀哄┑鐘灱濞夋盯鏁冮敂鍓х幓妞わ紕顢嘾ify闂備礁鎼ˇ顐﹀疾濠婂懐鐭欓柡宥庡幑閳ь兛绶氶獮瀣倷閻㈢數鏆俊鐐€栭崝鎴﹀垂瑜版帒�?
...
#3闂傚倷鐒︾€笛呯矙閹烘鍤屽Δ锝呭暞閸庡秹鏌曡箛銉х？闁崇粯鏌ㄩ埞鎴︽偐閹绘帗鐏撻梺绋跨應閸ャ劉鎷哄銈嗗姂閸╁嫬危閻戣姤鐓犻柛顭戝亜閻忔挳鏌熼姘殻鐎规洜鍠栭、鏃堝礋椤愵偅娴嗘繝鐢靛仜椤曨厽鎱ㄦ导鏉戠？闁哄被鍎遍悞鍨亜閹烘垵鏋ら柛銈嗙懇閺屾稑鈻庡Ο缁樺暱cost_price]闂傚倷鐒﹂惇褰掑礉瀹€鈧埀顒佸嚬娴滎亪骞冮幎绛嬫晬闁绘劖褰冮崬銊╂⒑閼归偊娼愬鐟版缁崵鐚鹃悞顤籥ntity]�?
...
buy [ISBN] [quantity] #1闂傚倷鐒︾€笛呯矙閹烘挾鈹嶆繛宸簻缁愭淇婇婵嗗惞闁崇粯娲熼弻鐔风暋閹殿喚鍔搁梺鎼炲€曢、宄塀N闂傚倷绀侀幉锟犳偡閳哄惤澶愬箻閺傘儲鐏侀梺纭呮彧缁犳垿鎮欐繝鍥ㄧ厱婵炲棗绉撮崝姘攽椤旂晫鐓俼uantity]�?

[ISBN] 婵犵數鍋為崹鍫曞箲娴ｅ壊娴栭柕濞у懐鐣舵繝銏ｆ硾閺堫剟骞嗛妷鈺傜厱婵炴垶鐟ラˉ瀣�?0婵犵數鍋犻幓顏嗗緤閻ｅ瞼鐭撻悹楦裤€€閺嬫棃鏌熺€电浠﹀ù婧垮€濋弻锝夊箛椤旇姤姣勯梺杞扮窔缁犳牠骞冨Δ鈧埥澶娾枎濡崵鏆俊鐐€栭崹鎶芥倿閿斿墽�?
[name] 闂傚倷绀侀幉锛勫垝鎼达絿绠旀慨鎺撴偉thor] 闂備浇宕甸崑鐐哄礄瑜版帒纾婚柛鏇ㄥ亽閸ゆ洟鎮归崶褎鈻曢柛銈嗘礋閺岋繝宕堕埡浣风捕婵犵數鍋涘ú顓㈠蓟濞戙垹鍐€鐟滃酣宕甸埀顒勬⒑閸︻厽顏熺紓宥勭椤曪綁宕奸弴鐐嶃劍銇勯弽銊х煂妞わ腹鏅滅换娑㈠箣閻愭潙纰嶇紓浣割槹閹告娊鐛崱娑橀唶闁靛鍎抽悡鎴︽煟韫囨洖浠ч柡鍜佸亞缁岸宕稿Δ浣哄幈濠电偛妫楃换鎰枔閳哄啰纾奸弶鍫涘妼閸濇椽鏌℃担鍝バゅù鐙呯畵閹虫牠鍩￠崘鎯ф櫖�?
闂傚倷绀侀幖顐︽偋濠婂牆绀堟繝闈涱儐椤ュ﹪鏌嶉崫鍕櫣缂佲偓閸愵喗鐓曟繛鎴濆船瀵箖鏌涢悢閿嬪缂佺粯绋撴禒锔剧矙閸喒鎷ゆ繝鐢靛Л閸嬫挸銆掑锝呬壕閻庤娲╃徊鎸庣閿曞倹鍋╃€光偓閳ь剟鍩炲☉銏♀�?
闂傚倷绀侀幉锟犲礉閺囥垹绠犻幖鎼厛閺佸﹪鏌熼柇锕€骞橀柍缁樻⒒閳ь剙绠嶉崕閬嶆偋韫囨挾鎽ラ梻?婵犵數鍋為崹鍫曞箹閳哄倻顩叉繝闈涱儐閸庢垿鏌ｉ敐鍛槵�?
[keyword] 闂傚倷娴囧銊╂嚄閸撲焦宕叉繝闈涚墢缁€濠囨倵閿濆骸澧柛瀣墬閵囧嫰骞囬埡浣轰患闂佽棄鍟伴崰鎾诲焵椤掍緡鍟忛柛鐘愁殔鐓ら柡宥庡厵娴滃綊鏌涜椤ㄥ懐绮堝畝鍕厱婵炴垶鑹鹃。鑲┾偓瑙勬礃婵炲﹪寮婚埄鍐ㄧ窞闁割偅绻傛慨椋庣磽娴ｄ粙鍝洪柣鐕傚缁瑦寰勬繝搴℃倯闂佸憡渚楅崰鏍礈閻㈠憡鈷戦柛娑橈功閹冲啴鏌ゅú璇茬仯婵″弶鍔欓崺锟犲川椤撶姷鍘梻浣告啞閸垶宕愬Δ鍐焼闁糕剝绋掗悡銉︾箾閹寸儐鐒鹃悗姘嵆閺屾稑鈻嶇拠鍙夊闁绘挶鍎查妵鍕籍閸パ傛睏闂佸湱鏅崰搴ㄥ煡婢舵劕妫樻繛鍡樺劤閸撹泛�?| (缂傚倸鍊烽悞锕€顫忚ぐ鎺撳亱婵犲﹤鐗嗛崥?闂傚倸鍊搁崐鎼佸箠韫囨稑钃熼柕濞у嫷娼熼梺纭呮彧闂勫嫰寮查鍕€堕柣鎰硾娴滃湱绱掗悩杈╃煓闁?
...
闂傚倷绀侀幉锟犲礉閺囥垹绠犻幖鎼厛閺佸﹪鏌熼悧鍫熺凡缂佺姵鍨块幃褰掑炊閵娿儳绁烽悷婊呭閻熴儵鍩ユ径鎰鐎规洖娉﹂妷褏纾煎璺猴功閹界姵绻?婵犵數鍋為崹鍫曞箹閳哄倻顩叉繝闈涱儐閸庢垿鏌ｉ敐鍛槵�?
[quantity] 婵犵數鍋為崹鍫曞箰妤ｅ啫纾块柕鍫濐槸濮规煡鏌ㄥ┑鍡╂Ц闁哄绶氶幃浠嬵敍閿濆懏鐏撶紓浣插亾?100000�?
闂備浇顕уù鐑藉极婵犳艾鐒垫い鎺嶈兌閵嗘帡鏌ら崷顓犫敋how闂傚倷鑳堕幊鎾绘倶濠靛牏鐭撶€规洖娲ㄧ粈濠囨煛閸愩劎澧涢柡鍜佸墰閳ь剙鍘滈崑鎾绘煕閹板吀绨介柣鎰礋濮婃椽宕ㄦ繝鍌滀患闂佺绨洪崐婵嬪箖瑜忕划娆忊枎閹勵吙闂傚鍋勫ú銈咁潩閿斿墽鐭嗛悗锝庡枟閻撱儲绻涢幋鐐垫噮妞わ絾鐓￠弻锝夋晜閼测晝锛熼梺璇″枟婢瑰棙绂掗敃鍌涘殐闁冲搫锕ｇ槐姗€姊绘担鍛婃儓闁绘绮撳畷婊堝Ω瑜庨～鏇熺節闂堟侗鍎忕紒鐘劦閺屽秷顧侀柛鎾跺枎椤曪綁宕归銏㈢獮婵犮垼娉涢ˇ杈╃不濮樿埖鈷戦悹鍥ｂ偓鍐插闂佹悶鍔岄悥鍏间繆閺夋埈鍚嬪璺侯儏閸擃喖顪冮妶鍡樼５闁稿鎸绘穱濠囶敃閿濆拋鍤嬬紓浣稿€圭敮鐐电磽閹炬剚�?闂傚倸鍊搁崐鎼佸箠韫囨稑钃熼柕濞у嫷娼熼梺纭呮彧闂勫嫰寮查鍕€堕柣鎰硾娴滆顨ラ悙鍙夘棦闁哄备鈧剚鍚嬪璺侯儜缁辩數绱撴担铏瑰笡鐎光偓閹间礁绠栭柟顖嗏偓閺嬪酣骞栧ǎ顒€鈧劙骞忛埄鍐閺夊牆澧介崚鎵磼鐎ｎ亜顏俊鍙夊姇閳规垿宕堕妸銉ュΤ闂備浇顫夐崕宕囧椤撱垹绠洪柣妯肩帛閻撴洘鎱ㄥ鍡楀⒋妞ゅ孩顨呴埞鎴︻敊閹傛闂佹悶鍔嶉崕鎶藉煘閹达箑鐐婇柕濠忕畱椤忎即姊绘担鍝勪缓闁稿氦灏欓崚鎺戠暆閸曨剙浠遍悷婊勬瀵偄顓奸崶锔藉媰缂備焦绋戦鍡涘箹?
...
report myself #3闂傚倷鐒︾€笛呯矙閹烘挾鈹嶉柧蹇氼潐瀹曟煡鏌熸潏鍓х暠闁绘劕锕弻锝夊箛椤掆偓缁狙囨煕閻樺弶鍣介柍褜鍓濋～澶愬箖閸洖纾块柟缁㈠枛閸氳绻濇繝鍌氭灓闁哥喎鎳樺鍫曞醇濮橆厽鐝曢梺浼欑秮娴滃爼寮婚悢鐓庡瀭妞ゆ梹瀚庨敍鍕＝鐎广儱妫欓埛鎺楁煙瀹勯偊鍎旂€殿喖澧庨幑鍕Ω椤噮鍙冨娲箰鎼达絺妲堥梺鍝勭墱閸撶喖骞冭缁瑥鈻庨幆褎顓块梻濠庡亜濞诧箓鎳濋幆褉鏋斿ù鐓庣摠�?
*/
...
//闂備浇宕垫慨鏉懨洪埡鍜佹晪鐟滄柨鐣烽敐澶婂耿婵炴垶顭囬悡鎴炵節閻㈤潧孝闁稿﹦顭堥銉╁箻缂堢姷绠氬銈嗗姉閸犲孩绂嶆ィ鍐┾�?
//initialization
const int block=70;
...
bool check_empty(string& s,int b){//濠电姷顣藉Σ鍛村磻閳ь剟鏌涚€ｎ偅宕岄柡宀嬬磿娴狅妇鎷犻幓鎺戭潚缂傚倷绶￠崰姘跺吹鏉堛劎绠鹃弶鍫濆⒔閸掓壆绱掓径濠勫煟闁诡喖娼″畷鍗炍旀繝鍌涱吙闂備線鈧偛鑻晶顖炴煙娓氬灝濡跨紓鍌涙崌椤㈡岸鍩€椤掆偓椤曪絾瀵奸幖顓熸櫖濠殿喗锕╅崢濂稿礈閵婏妇绠鹃柟瀵稿仦瀹曞嫭绻涢崪鍐М闁糕晝鍋ゅ浠嬪Ω瑜夐�?
...
class INPUT{
	...
	TYPE input(string s){
		...
		for(i=0;i<s.size();i++){
			...
			//闂傚倷绀侀幖顐⑽涘Δ鍛９闁荤喖鍋婂〒濠氭煕鐏炲墽銆掗柍缁樻⒒閳ь剙绠嶉崕閬嵥囬悧鍫㈩浄婵せ鍋撻�?
			else if(iden=="report"){
...
bool check(string s){//闂傚倷绀侀幉锛勬暜閸ヮ剙纾归柡宥庡幖閽冪喖鏌涢妷顔煎闁告瑥锕ラ妵鍕冀閵娧屾殹闂佺楠搁敃顏勵潖婵犳艾鐐婇柨婵嗘噸婢规洟姊绘担鍛婂暈閻㈩垱顨堥幑銏ゅ磼閻戝洨绋忛梺鍦濠㈡绮堝畝鍕厾闁归绀侀悘鐘炽亜韫囨洖鏋旂紒杈ㄥ笒閻ｆ繈鍩€椤掑倷鐒婇柕濞у嫷娼熷┑鐘绘涧椤戝懐绮堥崱妯肩闁糕剝锚缁椦呯磼閻樺磭鍙€�?闂傚倷鐒︾€笛呯矙閹达附鍤愭い鏍仜缁犳艾銆掑锝呬壕閻?
...
class Bignode{
	...
	int location;//闂傚倷绀佸﹢閬嶃€傛禒瀣；闁圭偓鍓氶悢鍡涙偣閸濆嫭鎯堟い蹇ｄ邯閺岋紕鈧綆浜滈弳鐐电磼閸屾稑娴€殿喚鏁婚幃浠嬫偨閺佸被鍨荤�?
...
class node{
	...
	long long key;int value;//闂傚倷绀侀幖顐λ囬鐐茬柈妞ゆ劧绠戦悞鍨亜閹哄棗浜鹃梺闈涚墛閹倸顕ｉ锔绘晣闁靛繒濮烽�?
	int next,prev;//闂傚倷绀侀幉锟犲箰閸濄儳鐭撻柟缁㈠枛缁犳牗淇婇妶鍕濞寸姵宀稿鍫曞醇濮橆厽鐝曢梺浼欑到瀹曨剟婀侀梺鎸庣箓閹虫劘鍊撮梻?
	int location;//闂佽崵鍠愮划搴㈡櫠濡ゅ懎绠伴柛娑橈攻濞呯娀鏌ｅΟ娆惧殭缂佺姰鍎甸弻宥堫檨闁告挻鑹鹃銉╁礋椤栨氨顦板銈嗗笂閼冲爼鍩€椤掑鏋涢棁澶愭煟濡寧鐝柡瀣缁辨挸顓奸崨顔兼�?
...
class BlockLinkList{
	...
	void split(Bignode& a){
		/*	node_type a;//闂佽崵鍠愮划搴㈡櫠濡ゅ懎绠伴柛娑橈攻濞呯娀鏌ｅΟ鑲╁笡闁稿﹦鍏橀弻娑㈡晜鐠囨彃绠洪梺浼欑秬娴滎剛妲愰幒妤婃晝闁靛鍠栧▓顓㈡�?
		String key;int value;//闂傚倷绀侀幖顐λ囬鐐茬柈妞ゆ劧绠戦悞鍨亜閹哄棗浜鹃梺闈涚墛閹倸顕ｉ锔绘晣闁靛繒濮烽�?
		int next,prev;//闂傚倷绀侀幉锟犲箰閸濄儳鐭撻柟缁㈠枛缁犳牗淇婇妶鍕濞寸姵宀稿鍫曞醇濮橆厽鐝曢梺浼欑到瀹曨剟婀侀梺鎸庣箓閹虫劘鍊撮梻?
		int location;//闂佽崵鍠愮划搴㈡櫠濡ゅ懎绠伴柛娑橈攻濞呯娀鏌ｅΟ娆惧殭缂佺姰鍎甸弻宥堫檨闁告挻鑹鹃銉╁礋椤栨氨顦板銈嗗笂閼冲爼鍩€椤掑鏋涢棁澶愭煟濡寧鐝柡瀣缁辨挸顓奸崨顔兼�?
		int head;*/
		/*
...
class USER{//闂傚倷鐒﹀鍨焽閸ф绀夌€广儱顦弰銉︾箾閹寸偟鎳呴柍鐟扮Ч閺屽秹鍩℃担鍛婃缂?
	...
	template<class T>//闂傚倷绶氬鑽ゆ嫻閻旂厧绀夌€广儱顦崙鐘绘煕閹般劍娅囨い鈺冨厴閹銈﹂幐搴哗闂佸摜鍠愰悡锟犲蓟濞戙垹绠抽柟鎯х亪濡插牏绱撻崒姘偓褰掑箰閼姐倗鐭欏鑸靛姇閻掑灚銇勯幒宥堝厡闁崇粯姊归妵鍕疀閹炬潙娅ら梺缁樻尨閸嬫挾绱撻崒娆戣窗闁稿顦甸、姘愁樄闁诡喗顨婇幃婊堟嚍閵夛附鐝梺璇茬箳閸嬫盯鍩€椤掑倸鏋庨柣婵愬灦閺屸剝寰勯崱妯荤彆闂佸搫琚崝宀€鍙呴梺鍝勭▉閸樿偐绮堥崒鐐寸厸闁割偁鍨洪弳鈺冪磼婢跺鍤熺�?
	void foundinend(T& a){
		file.open(F.c_str(),ios::in|ios::out|ios::binary);
		file.seekp(0,ios::end);
		a.location=file.tellp();
...
class LOG{
	...
	template<class T>
	T get(int location){//闂傚倷鑳堕崕鐢稿疾濞戙垺鍋ら柕濞у嫭娈伴梺鍝勵槹閸╁牓宕靛Δ浣风箚闁靛牆鍊告禍楣冩⒑缁洘娅呮い鏂垮煟cation婵犵數鍋犻幓顏嗗緤閻ｅ瞼鐭撻柛顐ｆ礃閸嬵亪鏌涢埄鍐姇闁稿骸绉归弻娑㈠即閵娿儰绨荤紓鍌氱С缁舵艾顫忓ú顏呭殤闁煎摜鏁搁妴濠傗攽閻愬瓨缍戞い锕備憾閸┾偓妞ゆ帒鍊归弳顒勬煃瑜滈崜姘辩矙閹剧粯鍤屽Δ锝呭暞閻撴盯鏌涢锝堝濞存粓绠栧娲川婵犲懎顥濆┑鐐存綑閸㈡煡鍩㈤幘璇茬闁绘劖娼欓鎾绘倵楠炲灝鍔氭繛灞傚姂�?
	...
	pair<double,double> 
		find(int key){//闂傚倷鑳堕幊鎾绘倶濮樿泛纾块柟鎯版閺勩儳鈧厜鍋撻柛鏇ㄥ亜閻濇﹢姊洪柅鐐茶嫰婢ь垱绻涢悡搴吋妤犵偛鐗忕紓鎾绘偉閺囩偐鏀介柣鎰级閿涙梻绱掓潏銊︾闁崇粯鎹囬獮瀣倷缂堢姵鍞夋繝鐢靛仦閸ㄥ墎鍒掑鍫涗汗婵炴垯鍨洪悡娆撴倵濞戞瑯鐒藉褎濞婇弻宥堫檨闁告挻鐟╅獮濠冩償閿涘嫭娈鹃梺缁橆焾椤曆呯矆閸曨垱鐓熼柟瀵稿€栭幋锕€绠氭繛鍡楃�?
		if(!key)key=getsum()-1;
...
class book{//婵犵數鍋為崹璺何涢幋鐘典笉闁瑰濮炬慨鎶芥⒑椤掆偓缁夋挳寮伴妷鈺傜厽闁瑰鍊栭幋锕€绠梺顒€绉甸悡鏇熶繆閵堝嫮鍔嶇痪鎹愬吹�?
	public:
	String ISBN,author,name,keyword[10];
	int location;//闂備浇宕垫慨鎶芥倿閿曗偓椤灝螣閼测晝顦悗骞垮劚椤︻垳绮堥崒鐐村仯闁惧繒鎳撻崝瀣椤掑澧撮柡宀嬬節瀹曟帒顫濋鐘靛幀婵犵數鍋涘Λ搴ㄥ垂閾忓湱鐭欏鑸靛姦閺佸洭鏌ｅΟ铏癸紞闁哄棛濮电换娑欐綇閸撗冨煂缂備礁顦悥濂稿�?
	double price;
	int quantity;
	bool ISBN_flag,author_flag,name_flag,keyword_flag,price_flag;
	book(){
...
class BOOK{
	...
	template<class T>//闂傚倷绶氬鑽ゆ嫻閻旂厧绀夌€广儱顦崙鐘绘煕閹般劍娅囨い鈺冨厴閹銈﹂幐搴哗闂佸摜鍠愰悡锟犲蓟濞戙垹绠抽柟鎯х亪濡插牏绱撻崒姘偓褰掑箰閼姐倗鐭欏鑸靛姇閻掑灚銇勯幒宥堝厡闁崇粯姊归妵鍕疀閹炬潙娅ら梺缁樻尨閸嬫挾绱撻崒娆戣窗闁稿顦甸、姘愁樄闁诡喗顨婇幃婊堟嚍閵夛附鐝梺璇茬箳閸嬫盯鍩€椤掑倸鏋庨柣婵愬灦閺屸剝寰勯崱妯荤彆闂佸搫琚崝宀€鍙呴梺鍝勭▉閸樿偐绮堥崒鐐寸厸闁割偁鍨洪弳鈺冪�?
	void foundinend(T& a){
		file.open(F.c_str(),ios::in|ios::out|ios::binary);
		file.seekp(0,ios::end);
		a.location=file.tellp();
	...
	void erase(book& a,int flag){//闂傚倷绀侀幉锛勬暜閻愬绠鹃柍褜鍓氱换娑㈠川椤撶儐鍔夌紓浣割儏椤︾敻宕洪埀顒併亜閹烘垵顏╅悗姘槹閵囧嫰骞嬪┑鍫滆檸婵犳鍠楅惄顖炲蓟閿濆惟闁靛鍎烘导鈧梻浣侯焾鐞氼偊宕濆畝鍕垫�?
